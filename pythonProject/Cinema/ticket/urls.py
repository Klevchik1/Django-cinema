...
urlpatterns = [
    ...
    path('admin/hall/edit/<int:movie_id>/', views.hall_edit, name='hall_edit'),
    path('admin/hall/delete/<int:movie_id>/', views.hall_delete, name='hall_delete'),
    ...
    path('admin/screening/edit/<int:movie_id>/', views.screening_edit, name='screening_edit'),
    path('admin/screening/delete/<int:movie_id>/', views.screening_delete, name='screening_delete'),
